...
class ConfigContent {
  ...
  int? gstCharge;
  double? travelingCharge;
  double? minimumAmountForTravelingCharge;
  int? tds;
  ...
  ConfigContent(
      {this.businessName,
        ...
        this.gstCharge,
        this.travelingCharge = 0.0,
        this.minimumAmountForTravelingCharge = 0.0,
        this.tds,
  ...
  ConfigContent.fromJson(Map<String, dynamic> json) {
    ...
    travelingCharge = json['traveling_charge'] != null
        ? double.tryParse(json['traveling_charge'].toString()) ?? 0.0
        : 0.0;
    minimumAmountForTravelingCharge = json['minimum_amount_for_traveling_charge'] != null
        ? double.tryParse(json['minimum_amount_for_traveling_charge'].toString()) ?? 0.0
        : 0.0;
    tds = json['tds'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['minimum_amount_for_traveling_charge'] = minimumAmountForTravelingCharge;
    data['tds'] = tds;
